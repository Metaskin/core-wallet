        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <Reveal delay={120} className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
              ...
              <div className="flex items-center gap-2 px-5 py-3.5 rounded-xl border border-gray-200 text-gray-600 text-sm">
                <span>📲</span> Install as app — tap Share then "Add to Home"
              </div>
            </div>
          </Reveal>
        </div>
