  ...
  const cols = [
    {
      ...
      links: [
        { label: 'Checking Account', href: '/services#checking',       sub: 'Free, no monthly fees'   },
        { label: 'Savings Account',  href: '/services#savings',        sub: 'High-yield earnings'     },
        { label: 'Debit Cards',      href: '/services#debit-cards',    sub: 'Virtual & physical'      },
        { label: 'Personal Loans',   href: '/services#personal-loans', sub: 'Competitive fixed rates' },
        { label: 'Mobile App',       href: '/services#mobile-app',     sub: 'Android — free download' },
      ],
    },
    {
      title: 'Business',
      ...
      links: [
        { label: 'Business Checking', href: '/services#business-checking', sub: 'Built for business'    },
        { label: 'Payroll Services',  href: '/services#payroll',           sub: 'On-time, every time'  },
        { label: 'Merchant Services', href: '/services#merchant',          sub: 'Accept any payment'   },
        { label: 'Business Credit',   href: '/services#business-credit',   sub: 'Flexible credit lines' },
        { label: 'Treasury',          href: '/services#treasury',          sub: 'Cash management'      },
      ],
    },
    {
      title: 'Wealth',
      ...
      links: [
        { label: 'Investment Advisory',  href: '/services#investment-advisory', sub: 'Personalised strategy' },
        { label: 'Portfolio Management', href: '/services#portfolio',           sub: 'Active monitoring'     },
        { label: 'Retirement Planning',  href: '/services#retirement',          sub: 'IRA & 401(k) guidance' },
        { label: 'Tax Services',         href: '/services#tax',                 sub: 'Minimise your tax bill' },
        { label: 'Trust Services',       href: '/services#trust',               sub: 'Estate & trust setup'  },
      ],
    },
    {
      title: 'Company',
