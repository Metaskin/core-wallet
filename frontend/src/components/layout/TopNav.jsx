    ...
    <>
      ...
      <header className="fixed top-0 inset-x-0 z-50 h-14 md:h-16 bg-white border-b border-gray-200 flex items-center px-4 md:px-6 gap-3">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          <div className="w-8 h-8 rounded-lg bg-navy flex items-center justify-center text-white font-bold text-sm shrink-0">
            C
          </div>
          <span className="font-bold text-navy text-lg tracking-tight hidden sm:block">CoreWallet</span>
        </div>
